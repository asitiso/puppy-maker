...
- Last verified implementation baseline: `2108ea5bea27a3b5c0ee076c9ff8cfc6204973a4`
- Verification: GitHub Actions CI #2491 passed on the current implementation HEAD.
...
2. Do **not** repeat V15 foundation/overworld work, any completed V16 region slice, registry consolidation, routing hardening, keyboard hardening, focused-control keyboard handling, or save/reload integration work.
...
V16 implementation and production-hardening are GREEN through CI #2491. Before inventing V17 without an approved design, continue release/readiness quality work:
...
- fix only concrete UX friction with a clear reduction in player confusion or input effort; avoid low-value cosmetic churn;
