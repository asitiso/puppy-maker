...
const css = readFileSync(new URL('./hollow-path.css', import.meta.url), 'utf8');
const component = readFileSync(new URL('./HollowPathHub.tsx', import.meta.url), 'utf8');

describe('Hollow Path mobile/accessibility contract', () => {
  ...
  it('keeps Journey keyboard-operable with Escape, focus trap and focus return', () => {
