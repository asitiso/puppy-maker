...
export default function V12BuildEditor({
  ...
  return <section className="v12-build-editor" role="dialog" aria-modal="true" aria-labelledby="v12-build-editor-title">
    <header className="v12-build-editor__header">
      <div><small>BUILD EDITOR</small><h3 id="v12-build-editor-title">{title}</h3></div>
      <button type="button" onClick={onClose} aria-label="빌드 편집 닫기">닫기</button>
    </header>
