...
export default function ActionResultSummary({title,message,changes=[],totals=[],continuationLabel,onContinue,buttonRef}:Props){
  return <section className="v10-result-summary" aria-label={title} role="status" aria-live="polite" aria-atomic="true">
    ...
    <button ref={buttonRef} type="button" className="v10-result-continue" onClick={onContinue}>{continuationLabel}</button>
  </section>;
}
