...
export function milestoneForCompletedMonths(completed:number):ProgressMilestone|null{return completed===3?'first-quarter':completed===6?'half-year':completed===9?'final-quarter':completed===12?'final-month':null}
